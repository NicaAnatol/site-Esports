...
<section class="contact-form-section">
    <div class="container2"><div class="border1">
    <div class="contact-form-wrapper">
    <h2>Don't shy to Contact us.</h2></div>
      <div class="contact-form-wrapper">
      <form class="contact-form" action="contact_get.php" method="post" onsubmit="return validateForm()">
    ...
    <button type="submit" class="button-style1">Send</button>
        ...
        <div class="contact-info">
          <p><strong>Location</strong><br>Chisinau strada Vasile Lupu 8</p>
          <p><strong>Phone</strong><br>+40-123-456-789</p>
          <p><strong>E-mail</strong><br>anatol.nica00@e-uvt.ro</p>
        </div>
      </div>
    </div></div>
  </section>
